...
The subcommand \code{shallow} expects as \code{<file>} a file named \code{X\_ShallowShared\_Tuples.thy} which has been generated
by Cogent for a ``proof name'' \code{X}. It expects the file \code{X\_Shallow\_Desugar\_Tuples.thy} in the same directory 
...
The subcommand \code{refine} expects as \code{<file>} a file named \code{X\_ShallowShared.thy} which has been generated
by Cogent for a ``proof name'' \code{X}. It expects the file \code{X\_Shallow\_Desugar.thy} in the same directory 
...
The subcommand \code{shallow} is implemented by applying the filters \code{auxcog-shalshared} and \code{auxcog-shargencot} to 
the content of file \code{X\_ShallowShared\_Tuples.thy} to generate the modified file \code{X\_ShallowShared\_Tuples.thy}
and the file \code{X\_Shallow\_Gencot\_Tuples.thy}. The file \code{X\_Shallow\_Desugar\_Tuples.thy} is directly modified using
\code{sed} (only replacing the theory import). The remaining files are simply copied from the Gencot distribution.

The subcommand \code{refine} is implemented by applying the filters \code{auxcog-shalshared} and \code{auxcog-shargencot} to 
the content of file \code{X\_ShallowShared.thy} to generate the modified file \code{X\_ShallowShared.thy}
and the file \code{X\_Shallow\_Gencot.thy}. The file \code{X\_Shallow\_Desugar.thy} is directly modified using
\code{sed} (only replacing the theory import). The remaining files are simply copied from the Gencot distribution.
