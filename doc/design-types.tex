...
a valid pointer to the global variable, it will never be \code{NULL}.
...
type of the form \code{CArr<size> El} for the Global-State parameters. Since the variable is statically defined, the pointer
passed as parameter cannot be \code{NULL} and Gencot also omits \code{MayNull} in this case. Together, whenever Gencot maps an array type
