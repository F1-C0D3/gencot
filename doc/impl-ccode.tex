...
The user state is used by Gencot in this processing phase to make the actual name of the processed file available 
during processing. In the \code{NodeInfo}
...
The monadic type is defined as
\begin{verbatim}
