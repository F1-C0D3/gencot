...
The Cogent compiler generates an formal specification and it generates a refinement proof that the specification
...
from translating a C program with Gencot.
