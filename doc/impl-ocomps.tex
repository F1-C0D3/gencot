...
\item[\code{auxcog-shalgencot}] processes an Isabelle theory for generating an additional Isabelle theory.
\item[\code{auxcog-shalshared}] postprocesses an Isabelle theory for adapting type definitions.
\item[\code{auxcog-lemmgencot}] processes an Isabelle theory for generating an additional Isabelle theory.
...
Section~\ref{impl-ocomps-main}). It generates the Isabelle theory to be stored in file \code{X\_Shallow\_Gencot\_Tuples.thy}
...
This filter works similar as \code{auxcog-shalgencot}. It generates the Isabelle theory to be stored in file 
