...
components list. These entries name the standard include files which are part of the Gencot distribution. Since 
some of them have no corresponding theory, since they do not define abstract functions, \code{auxcog-embedding}
