...
\code{auxcog-ctypstruct} and \code{auxcog-ctypfunc}. They are implemented as Haskell programs. They take
the preprocessed \code{.h} file generated by Cogent as input and write the textual type information 
as described in Section~\ref{impl-ctypinfo-repr} to their output.

The filter \code{auxcog-ctypstruct} generates the information about struct types, as described in 
Section\ref{impl-ctypinfo-struct}, the filter \code{auxcog-ctypfunc} generates the information about 
