...
struct as4 { int m7; int m8[5]; };
struct as1 fas1r(struct as1 s) { return s; }
...
int fas11(struct as1 s, int v) { return v = (fas1r(s)).m1,v; }
int fas12(struct as4 s, int v) { return v = s.m8[3],v; }
int fas13(struct as4 s) { return s.m8[3] = 42,s.m8[3]; }
int fas14(struct as4 s) { return s.m8[3]++; }
...
int faa15(aa4 a, int v) { return v = a[3][2],v; }
int faa16(aa4 a) { return a[3][2] = 42,a[3][2]; }
int faa17(aa4 a) { return a[3][2]++; }

struct as3 { int m5; struct as1 *m6; };
typedef int *aa3[5];
struct as1 *fas1pr(struct as1 *p) { return p; }
...
int fap16(struct as1 *p, int v) { return v = (fas1pr(p))->m1,v; }
int fap17(struct as1 *p) { return (fas1pr(p))->m1 = 42,(fas1pr(p))->m1; }
int fap18(struct as1 *p) { return (fas1pr(p))->m1++; }
