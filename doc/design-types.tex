...
constant. This has two consequences. First, a C function pointer type cannot be mapped by Gencot to a Cogent function type,
...
since array types are adjusted to pointer types when used as parameter type, and are not allowed as function result types in C.

The abstract functions for translating between abstract an function types in Cogent are named 
\begin{verbatim}
  from_<name>
  to_<name>
\end{verbatim}
