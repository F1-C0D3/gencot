...
Both filters must map original C identifiers to their Cogent form. This requires the use of the name prefix
map file, as described in Section~\ref{impl-ccode-names}. Therefore, both filters take the name of this file as
