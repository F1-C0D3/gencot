...
\item[\code{items-local}] processes a single file \code{x.c} and generates a list of all items with internal linkage 
...
\item[\code{items-common}] generates a list of all items with external or no linkage 
for which properties may be declared.
\end{description}
