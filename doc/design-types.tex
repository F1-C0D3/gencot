...
of linear type. Gencot adds a parameter to the result tuple if the Add-Result property has been declared for the 
parameter, as described in Section~\ref{design-types-itemprops}. 
...
developer by omitting the Add-Result property from a parameter of linear type.
...
\begin{itemize}
\item If the C type of a parameter has no Add-Result property, it is translated as described before.
\item Otherwise, if the parameter has the Read-Only property and no Add-Result property
