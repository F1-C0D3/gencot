...
Cogent record types are used for mapping C struct types and C pointer types. The create/dispose functions for
...
the main function is defined as polymorphic using type parameter \code{a}. \code{a} is restricted to be regular or readonly, so it can be discarded by \code{modifyin\_A'<size>'\_El}.
