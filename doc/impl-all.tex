...
The subcommand \code{shallow} is implemented by applying the filters \code{auxcog-shalshared}, \code{auxcog-shalgencot},
and \code{auxcog-lemmgencot} to 
the content of file \code{X\_ShallowShared\_Tuples.thy} to generate the modified file \code{X\_ShallowShared\_Tuples.thy}
and the files \code{X\_Shallow\_Gencot\_Tuples.thy} and \code{X\_Shallow\_Gencot\_Lemmas.thy}. 
...
The subcommand \code{refine} is implemented by applying the filters \code{auxcog-shalshared} and \code{auxcog-shalgencot} to 
