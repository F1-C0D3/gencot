...
and thus a dfinition for it occurs in at most one of the symbol tables.
...
\end{verbatim}
in module \code{Gencot.SymTab}. It should be applied to the tables built by \code{readFromFile} for two different
