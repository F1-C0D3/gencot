...
processes all used derived types.
\item[\code{gencot-dvdtypesac}] generates the content to be put in the file \code{<package>-dvdtypes.ac}. It 
processes all used derived types.
...
types functions may be defined manually. Therefore \code{gencot-exttypes} also handles all syntactic
...
The processor \code{gencot-dvdtypes} generates all Cogent type and function definitions for the derived types
...
derived types are omitted by \code{gencot-dvdtypes}.
...
\subsubsection{Processor \code{gencot-dvdtypesac}}
