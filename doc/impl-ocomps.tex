...
\item types of the form \code{'a CArrPtr} are mapped to \code{'a list},
\item types of the form $\code{'a CArr<size>}_T$ are mapped to \code{(<nr>, 'a) FixedList CArr<size>} where 
