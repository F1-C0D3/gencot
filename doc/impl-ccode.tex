...
When the parser results are combined it is relevant, how they are structured. The language-c parser 
Also for combining the parser results there are several possibilities. 

The combination can be done before or after the analysis phase. 
