...
depending on the expression bound to \code{v<n>'} in the binding list pair for \code{e} as described above, and \code{r<k>'} 
...
binding the value of \code{e2}, \code{i<k>'} is the index variable corresponding to \code{r<k>'}, and \code{<v>} and \code{r<k>'} 
