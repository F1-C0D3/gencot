...
array, the parameter is used to pass a pointer to it, then an additional pointer dereference is generated by Gencot.
...
is only used for the result of equational, relational, and boolean operators.
